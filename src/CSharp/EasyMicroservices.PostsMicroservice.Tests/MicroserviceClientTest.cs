...
namespace EasyMicroservices.PostsMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Posts.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
